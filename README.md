...
| :--- | :--- | :--- | :---: |
| **Grayscale** | `Edit -> Grayscale` | Converts color pixels to intensity using BT.601 weighted luminance: `gray = 0.299*R + 0.587*G + 0.114*B` | <img src="এখানে_গ্রে স্কেল_ছবির_লিংক" width="220"> |
| **Brightness** | `Edit -> Brightness Adjustment` | Adds/subtracts user scalar `S` in [-255, 255] with clamping to [0, 255]: `C' = clamp(C + S)` | <img src="এখানে_ব্রাইটনেস_ছবির_লিংক" width="220"> |
